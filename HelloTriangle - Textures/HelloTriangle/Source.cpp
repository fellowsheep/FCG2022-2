...
//#endif
	...
	GLuint texID = generateTexture("../textures/lava1.png");
	GLuint texID2 = generateTexture("../textures/lava2.png");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glBindTexture(GL_TEXTURE_2D, texID5); //conecta a textura desejada
